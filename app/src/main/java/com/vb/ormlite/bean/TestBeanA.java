 ...
 */
@DatabaseTable(tableName = "table_testa")
public class TestBeanA {
    ...
    public TestBeanA(String _id, String title, String img, String time) {
        this._id = _id;
        this.title = title;
        this.img = img;
        this.time = time;
    ...
    public TestBeanA(String _id, String title, String img, String time, int tmp0, String tmp1, String tmp2) {
        this._id = _id;
        this.title = title;
        this.img = img;
        this.time = time;
